...
class MediumBot extends Human {
    ...
    /** @var string */
    public $name = T::AQUA . T::BOLD . "Medium " . T::RESET . T::GRAY . "Bot";
    ...
    /** @var float */
    public $potTicks = 20 * 5;

    /** @var int */
    public $jumpTicks = 10;

    /** @var int */
    public $attackcooldown = 6;

    /** @var int */
    public $reachDistance = 3.5;
    ...
    public function __construct(Level $level, CompoundTag $nbt, array $settings, Practice $plugin)
    {
